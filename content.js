...
export const POSTS = [
  ...
  { slug: "frozencreativeteam", cat: "News", date: "Apr 27, 2026", read: "3 min", author: "CentreStage Frozen",
    title: "CentreStage Announces Core Creative Team for Frozen — March 2027",
    img: fill("35cad6_73da71cc3aa646b5884eb6b2614e5eb5~mv2.png", 1200, 800),
    excerpt: "Meet the core creative team bringing Frozen to the Geelong Arts Centre stage in March 2027.",
    body: [
      "CentreStage is proud to officially announce the core creative team behind our 2027 production of Frozen, at the Playhouse Theatre, Geelong Arts Centre, from 5 to 21 March 2027.",
      "The team: Producer Martin Nguyen; Director Michele Marcu; Assistant Director Jesse Simpson; Choreographer Chloe Quinney; Musical Director Phil Kearney; Assistant Musical Director Britteny Ling; Vocal Director Liz Kearney; and Production Manager David Greenwood OAM.",
      "“This team represents the very best of what our region has to offer. We've brought together artists who understand the responsibility of telling this story, while also creating opportunities for our community and the next generation of performers,” said producer Martin Nguyen.",
      "Director Michele Marcu leads with a clear vision: a version of Frozen that is entertaining and visually engaging, but also authentic and emotionally resonant — built on clarity of narrative, honest character-driven performance and a connected ensemble. Under Musical Director Phil Kearney, the production will prioritise a full, rich orchestral sound.",
      "Beyond the stage, Frozen has been designed as a whole-of-community experience — with inclusive casting, a safe and supportive rehearsal environment, clear pathways for young performers, and Relaxed and Accessible Performances so more members of the community can experience live theatre. March 2027 is just the beginning."
    ] },
