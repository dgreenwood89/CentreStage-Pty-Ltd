...
export const POSTS = [
  { slug: "frozen-cast-announcement", cat: "Cast Announcement", date: "Sep 21, 2026", read: "6 min", author: "CentreStage",
    title: "Announcing the Cast of Disney's Frozen",
    img: "assets/blog/cast/hero-banner.png",
    excerpt: "From hundreds of auditions across five nights, a company has been found. Meet the performers bringing Arendelle to The Playhouse in March 2027.",
    bodyRich: [
      { p: "GEELONG, 21 September 2026 — CentreStage today announced the full company for Disney's Frozen, playing fifteen performances only at The Playhouse, Geelong Arts Centre, from 5 to 20 March 2027." },
      { p: "The casting follows one of the largest audition processes the company has undertaken: five nights of vocal auditions at Cloverdale Community Centre, a full dance and movement call at Geelong High School, a dedicated workshop for young performers, and a day of callbacks. Hundreds of performers auditioned." },
      { h: "Principal cast" },
      { list: ["Elsa — Jamie Long", "Anna — Emillie King", "Kristoff — Jake Birley", "Hans — Vin R Quach", "Olaf — Liam Charleston", "Sven — Shaughn Pegoraro"] },
      { h: "Understudies" },
      { list: ["Elsa — Caitlin Garner", "Anna — Cassiana Marcu"] },
      { h: "Young Elsa and Young Anna" },
      { p: "Six young performers share the roles across three casts. Each cast performs five of the fifteen shows." },
      { list: ["Fjord Cast — Molly Jones (Young Elsa) and Anna Moorfoot (Young Anna)", "North Mountain Cast — Cleo McMiles (Young Elsa) and Andina Moore (Young Anna)", "Enchanted Forest Cast — Aria McHenry (Young Elsa) and Jessie Grinter (Young Anna)"] },
      { h: "Youth performance schedule" },
      { list: ["Fjord Cast — Fri 5 Mar 7.30pm, Sun 7 Mar 5.00pm, Thu 11 Mar 7.30pm, Sat 13 Mar 7.30pm, Sat 20 Mar 1.30pm", "North Mountain Cast — Sat 6 Mar 1.30pm, Fri 12 Mar 7.30pm, Sun 14 Mar 12.00pm, Thu 18 Mar 7.30pm, Sat 20 Mar 7.30pm", "Enchanted Forest Cast — Sat 6 Mar 7.30pm, Sat 13 Mar 1.30pm, Sun 14 Mar 5.00pm, Wed 17 Mar 7.30pm, Fri 19 Mar 7.30pm"] },
      { h: "Supporting roles" },
      { list: ["Duke of Weselton — Jake Waterworth", "Oaken — Jack McPhail", "Pabbie — Eliot Cudmore", "Bulda — Akanksha Taori", "King Agnarr — Adam Vriens", "Queen Iduna — Kaitlyn Eastwood", "Bishop — Trent Inturrisi", "Handmaidens — Ava Davies, Amy Koenig and Julianne Wilde", "Ladies in Waiting — Mandie Lee and Hannah Senftleben", "Kitchenmaids — Harriet Stepto and Jasmin Wilson"] },
      { h: "Dance captains" },
      { list: ["Aneiki Liddle", "Jeremy Logan"] },
      { h: "Featured dancers" },
      { list: ["Bec Del Bianco", "Laura McKenzie", "Rosie Tuck", "Ella White", "Samuel Holzberger", "Will Roffey", "Declan Parisi", "Colby McCallum", "Xanthe Stangel", "Campbell Van Elst"] },
      { h: "From our Managing Director" },
      { p: "“Sixteen years ago we were a handful of people with an idea and a hall. Today we are announcing a company of this size, for a title of this scale, in a venue like The Playhouse. That is not our achievement — it belongs to every performer, family and volunteer who backed us,” said David Greenwood OAM, Managing Director of CentreStage." },
      { p: "“The standard in those audition rooms was extraordinary, and I want to acknowledge everyone who auditioned. Being asked to choose between performers of that calibre is a genuinely difficult privilege. To those we could not cast this time — please come back. Our door does not close.”" },
      { h: "From our Director" },
      { p: "“What struck me across the whole process was not just the talent, but the generosity,” said Michele Marcu, Director. “Performers supporting each other in the corridor, older auditionees looking after the younger ones, people cheering for the person who might be auditioning for the same role. That is the company I wanted to build, and that is exactly what we have.”" },
      { h: "Performance details" },
      { list: ["Season — 5 to 20 March 2027", "Venue — The Playhouse, Geelong Arts Centre", "Performances — fifteen only", "Tickets — geelongartscentre.org.au", "Media enquiries — david@centrestage.org.au, (03) 5272 1775"] },
      { p: "Disney's Frozen is licensed exclusively by Music Theatre International (Australasia)." }
    ],
    gallery: [
      { img: "assets/blog/cast/elsa.png", cap: "Jamie Long · Elsa" },
      { img: "assets/blog/cast/anna.png", cap: "Emillie King · Anna" },
      { img: "assets/blog/cast/leads-1.png", cap: "Jake Birley · Kristoff / Vin R Quach · Hans" },
      { img: "assets/blog/cast/leads-2.png", cap: "Liam Charleston · Olaf / Shaughn Pegoraro · Sven" },
      { img: "assets/blog/cast/understudies.png", cap: "Caitlin Garner and Cassiana Marcu · understudies" },
      { img: "assets/blog/cast/young.png", cap: "Young Elsa and Young Anna · three casts" },
      { img: "assets/blog/cast/youth-dates.png", cap: "Youth performance schedule" },
      { img: "assets/blog/cast/supporting-1.png", cap: "Supporting roles" },
      { img: "assets/blog/cast/supporting-2.png", cap: "Supporting roles, continued" },
      { img: "assets/blog/cast/supporting-3.png", cap: "Supporting roles, continued" },
      { img: "assets/blog/cast/company-1.png", cap: "Dance captains and featured dancers" },
      { img: "assets/blog/cast/company-2.png", cap: "Featured dancers" },
      { img: "assets/blog/cast/closing.png", cap: "Arendelle awaits · tickets on sale now" }
    ],
