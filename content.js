...
export const POSTS = [
  { slug: "sweet-16", cat: "News", date: "Aug 2026", read: "6 min", author: "David Greenwood",
    ...
    excerpt: "This year, CentreStage celebrates 16 years of creating opportunities for performers, families and artists across Greater Geelong.",
    body: [
      "What began in 2010 has grown into a substantial regional performing arts organisation, supporting hundreds of young people each week, employing local artists and arts workers, representing performers through our talent agency and staging productions of a scale we once could only have imagined.",
      "As we celebrate this milestone, we are also preparing CentreStage for its next era."
    ],
    bodyRich: [
      { h: "A new head office" },
      { p: "We have recently relocated our head office to Unit 2, 255 Hamilton Highway, Fyansford." },
      { p: "This new base provides additional administrative, meeting and teaching space while allowing us to strengthen the systems supporting our education programs, productions, talent agency and broader operations. It is one part of a carefully planned transition as CentreStage continues to grow." },
      { img: "assets/blog/sweet16/team-circle.jpg", alt: "The CentreStage creative team in a planning circle", cap: "Strengthening the systems behind our programs, productions and agency." },
      { p: "Families are already loving our new space, and we can't wait to see the organisation efficiency as a result of the new office space." },
      ...
      { p: "Our vision includes an affordable theatre that continues to support CentreStage programs while also creating new possibilities for community organisations, independent artists and local performing arts groups." },
      { img: "assets/blog/sweet16/beauty-spotlight.jpg", alt: "A CentreStage performer under a single spotlight", cap: "Our vision: an affordable theatre for the whole community." },
      { p: "These discussions remain subject to negotiation and we will share confirmed information with our community when it is appropriate and responsible to do so." },
      { p: "Periods of growth and transition can understandably create uncertainty, particularly when they involve changes to locations, or adjustments to the way programs operate." },
      { p: "CentreStage's current program is not affected." },
      { p: "Should any future change affect a particular class, rehearsal or production, the people involved will receive clear information directly from CentreStage with appropriate notice and support." },
      { h: "Stronger than ever" },
      { p: "We have recently completed a new five-year strategic plan for CentreStage. It sets out ambitions that would have seemed almost unimaginable when the organisation began 16 years ago." },
      { p: "The plan focuses on creating more opportunities for young people, improving access to the performing arts, strengthening regional employment, supporting community theatre and developing facilities that respond to Geelong's growing creative needs." },
      { img: "assets/blog/sweet16/community-stall.jpg", alt: "CentreStage volunteers at a community stall", cap: "Strengthening regional employment and community theatre." },
      { p: "Property arrangements may change. Buildings may be sold, leased or repurposed. What does not change is CentreStage's commitment to its performers, students, families, employees and community." },
      { p: "At 16, CentreStage is stronger, more experienced and more ambitious than ever. We are proud of what our community has built and genuinely excited about what comes next." },
      { img: "assets/blog/sweet16/outdoor-stage.jpg", alt: "CentreStage performing on an outdoor community stage", cap: "Proud of what our community has built together." },
      { p: "I wish we could unveil our new building for our 16th birthday, but it's very close." },
      { p: "If any parent or community member feels worried, I encourage them to connect with their teacher, director, or me at david@centrestage.org.au." },
      { p: "Theatrically," },
      { p: "David Greenwood OAM" }
    ] },
